...
def _get_qvm_compiler(qvm_type, endpoint: str, device: AbstractDevice) -> AbstractCompiler:
...
def _get_9q_square_qvm(name: str, qvm_type: str, connection: ForestConnection,
