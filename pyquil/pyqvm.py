...
# NOTE: both quilc-QVM and qcs-QPU QAMs have asynchronous
# methods `execute`, `get_result`, and `run`.
# In order to maintain a common interface these methods do also,
# despite the fact they are synchronous.
