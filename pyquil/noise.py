...
class Calibrations:
	...
	def _change_fidelity_by_noise_intensity(self, fidelity: Dict[Any, float], intensity: float):
		"""
...
def add_noisy_gates_to_program(new_p: Program, prog: Program, noise_gates: Dict,
                               damping_after_dephasing_after_2q_gate: bool, damping_after_dephasing_after_1q_gate: bool,
                               depolarizing: bool, damping_after_dephasing_only_on_targets: bool):
	"""
...
def add_kraus_maps_to_program(new_p: Program, calibrations: Calibrations, delay_gates: Dict, depolarizing: bool,
                              damping_after_dephasing_after_1q_gate: bool, damping_after_dephasing: bool,
                              readout_noise: bool):
	if depolarizing:
...
def add_noise_to_program(
	...
	new_p = add_kraus_maps_to_program(new_p, calibrations, delay_gates, depolarizing,
	                                  damping_after_dephasing_after_1q_gate,
	                                  damping_after_dephasing_after_2q_gate, readout_noise)
