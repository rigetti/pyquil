...
def expand_defcircuits(
    ...
    expand_names_except: AbstractSet[str] = frozenset(),
) -> Program:
    ...
    :param expand_names_except: Set of DefCircuit names to skip during expansion.
        Instructions matching these names are left unexpanded.
    ...
    for inst in instructions:
        if isinstance(inst, Gate):
            instruction_name = inst.name
            if instruction_name in expand_names_except:
