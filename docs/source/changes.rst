...
- Operator estimation now offers a "greedy" method for grouping terms that share a tensor
  product basis (tpb) as an alternative to the clique cover version (gh-754).
