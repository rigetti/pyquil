# -*- coding: utf-8 -*-
#
# pyQuil documentation build configuration file, created by
...
latex_documents = [(master_doc, "pyQuil.tex", "pyQuil Documentation", "Rigetti Computing", "manual")]
