...
Most API keys give access to the QVM with up to 16 qubits for the SyncConnection and up to 26 qubits
for the JobConnection. If you would like access to more qubits or help running larger jobs,
then contact us at support@rigetti.com.
