...
- [ ] (User-visible change) A changelog entry has been added under [`changelog.d/`][changelog].
- [ ] (Bugfix) The associated issue is referenced above using [auto-close keywords][auto-close].

[auto-close]: https://help.github.com/en/articles/closing-issues-using-keywords
[changelog]: https://github.com/rigetti/pyquil/blob/master/changelog.d/README.md
